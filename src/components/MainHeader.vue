  ...
  <header>
    <div class="container">
      ...
      <nav class="navigation">
        <router-link @click="closeBurgerMenu" to="/delivery"
          >Доставка</router-link
        >
        <router-link @click="closeBurgerMenu" to="/articles"
          >Статьи</router-link
        >
        <router-link @click="closeBurgerMenu" to="/about">О нас</router-link>
        <router-link @click="closeBurgerMenu" to="/contacts"
          >Контакты</router-link
        >
      </nav>

      <div class="contacts">
        <a href="email:support@wwwwwww.com" class="link-email"
          >support@wwwwwww.com</a
        >
      ...
      <template v-if="windowInnerWidth <= 1024">
        <div class="mobile-actions-btn">
          <a href="tel:88001111111" class="ic-phone"
            ><img src="@/assets/img/icons/phone.svg"
          /></a>
          <span
            @click="toggleBurgerMenu"
            class="btn-burger"
            :class="isActivBurgerMenu"
          ></span>
        </div>
